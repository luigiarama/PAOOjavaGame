...
public class UI {
    ...
    GamePanel gp;
    Graphics2D g2;
    Font fixedsys_30 = new Font("Bauhaus 93", Font.PLAIN, 30);
    Font fixedsys_40 = new Font("Bauhaus 93", Font.PLAIN, 40);
    Font arial_50 = new Font("Arial", Font.BOLD, 50);
    Font fixedsys_60 = new Font("Bauhaus 93", Font.PLAIN, 60);
    Font fixedsys_80 = new Font("Bauhaus 93", Font.BOLD, 80);
    Font arial_30 = new Font("Arial", Font.BOLD, 30);
    ...
    public void paint(Graphics2D g2) {
        ...
        if(gp.gameState == gp.playState && gp.currentMap == 0){
            ...
            g2.drawString("  Assemble on table", gp.tileSize+2, gp.tileSize*15-15);
            ...
            g2.setFont(arial_30);
            g2.setColor(new Color(158,8,202));
            g2.drawString("  Make 2 burgers  ",gp.tileSize+2, gp.tileSize*2);
        ...
        //LEVEL 2 UI
        }else if(gp.gameState == gp.playState && gp.currentMap == 1){

            //INFO FOR LEVEL PANEL
            drawInfo();
            g2.setFont(arial_30);
            g2.setColor(new Color(8, 208, 226));
            g2.drawString("        ---LEVEL 2--- ", gp.tileSize+2, gp.tileSize*8);
            g2.drawString("  Help Chef Alex to", gp.tileSize+2, gp.tileSize*9);
            g2.drawString("  cook 2 burgers  ", gp.tileSize+2, gp.tileSize*10);
            g2.drawString("  and 4 burritos", gp.tileSize+2, gp.tileSize*11);

            g2.drawString("  Burrito recipe: ", gp.tileSize+2, gp.tileSize*12);
            g2.drawString("  Dish + Pita", gp.tileSize+2, gp.tileSize*13);
            g2.drawString("  Ham + Salad", gp.tileSize+2, gp.tileSize*14);
            g2.drawString("  Assemble on table", gp.tileSize+2, gp.tileSize*15-15);
            ...
            g2.setColor(new Color(8,208,226));
            g2.drawString("  Make 2 burgers  ",gp.tileSize+2, gp.tileSize*2);
            g2.drawString("  and 4 burritos : ",gp.tileSize+2, gp.tileSize*3);
            ...
            if(gp.player.borgar_cnt >= 2 && gp.player.burrito_cnt >= 4) {
                //Font fixedsys_50 = new Font("Bauhaus 93", Font.PLAIN, 50);
                g2.setFont(fixedsys_40);
                g2.setColor(Color.yellow);
                g2.drawString("  Congratulations! You finished Level 2, go to the UFO!", gp.tileSize * 6, gp.tileSize * 10 - 20);
    ...
    private void drawTitleState() {
        ...
        try {
            ...
            uTool.scaleImage(bf,gp.tileSize,gp.tileSize);
    ...
    public void drawInfo(){
        ...
        int frameWidth = gp.tileSize*5+10;
