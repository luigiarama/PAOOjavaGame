...
public class UI {
    ...
    private void updateLevel3Timer() {
        ...
        if (playTime > 150) {
            gp.gameState = gp.gameOverState;
        } else if (gp.player.score >= 1000) {
            g2.setColor(Color.red);
            g2.drawString("Congratulations! You finished Level 3 in " + dFormat.format(playTime) + " seconds, go back to BULARGA!", gp.tileSize * 6, gp.tileSize * 10 - 20);
        }
    }
