...
public class TileManager {
    ...
    public void getTileImage(){
        try{
            ...
            tile[5] = new Tile();
            tile[5].image = ImageIO.read(getClass().getResourceAsStream("/tiles/check.png"));
            tile[6] = new Tile();
            tile[6].image = ImageIO.read(getClass().getResourceAsStream("/tiles/purple.png"));
            tile[7] = new Tile();
            tile[7].image = ImageIO.read(getClass().getResourceAsStream("/tiles/white.png"));
            tile[8] = new Tile();
            tile[8].image = ImageIO.read(getClass().getResourceAsStream("/tiles/cyan.png"));
            tile[9] = new Tile();
            tile[9].image = ImageIO.read(getClass().getResourceAsStream("/tiles/check_blat.png"));
            tile[9].collision = true;
            tile[10] = new Tile();
            tile[10].collision = true;
            tile[10].image = ImageIO.read(getClass().getResourceAsStream("/tiles/check_fridge.png"));
            tile[11] = new Tile();
